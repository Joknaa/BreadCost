...
public class MainPanel extends JPanel implements IPanel, ActionListener {
    ...
    private final DefaultListModel<String> usersOnlineListModel = new DefaultListModel<>();
    private final DefaultListModel<String> usersOfflineListModel = new DefaultListModel<>();
    ...
    /*
    public DefaultListModel<String> getUserOnList() {
        return usersOnlineListModel;
    }
    @Override
    public void online(String login) {
        usersOnlineListModel.addElement(login);
    }
    @Override
    public void offline(String login) {
        usersOnlineListModel.removeElement(login);
    }
